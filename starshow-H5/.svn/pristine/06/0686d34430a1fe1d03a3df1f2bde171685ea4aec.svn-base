		    ...
		    series: [
		        {
		            ...
		            data:[1.51,1.44,1.39,4.34,1.51,1.44,1.39,1.34
		            ]
		        },
		        {
		            name:'降雨量',
...
var initLineChart=function (data,options) {
	var myChart = echarts.init(document.getElementById('main'));
	/*if(data.data.length>8){
      option.xAxis[0].axisLabel.interval=parseInt(data.data.length/6);
    }else{
...
var dspCommonFun=function(){
	$(".dsp_tabs .tab").click(function(){
