   ...
   //活动分享
    var shareActivity=function(){
      setBridgeCallHandler(bridge, {
        'action': '3',
        'share': {
          'share_url':"https://lookmetv.com/activity/starZeroRange5/share.html",
          'title': "星秀福利社之约定卢杉",
          'content': "来时尚星秀APP，手动点评参与互动，赢取“靖王妃”卢杉签名福利！",
          'cover': "https://starshow-pic.b0.upaiyun.com/default/lushan.jpg"
        }
      })
    }
})
  ...
  var initCommentPage=function(){
      ...
      if($("#btn_down").html()!=undefined){
	      $(".btn_msgSend").click(function(){
	        ...
	        if(jwt_token=="" || jwt_token==undefined){
            //授权
             window.location.href = host+"wechat/activityAuth?type=starZeroRange5";
         }else{
	          toComment(jwt_token);
	        }
	      })
