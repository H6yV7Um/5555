...
function openApp_obj(to, obj_map) {
	...
	if (browser.versions.ios) {
		var appUrl = "https://xingxiu.tv/applinks/index.html?data=" + params;
	} else if (browser.versions.android) {
		if (browser.versions.weixin) {
			var appUrl = "http://t.cn/R7COgYb";
		} else if(browser.versions.weibo) {
			var appUrl = "https://xingxiu.tv/applinks/index.html";
		} else {
			var appUrl = "xingxiu://starshow.com?data=" + params;
			...
			window.setTimeout(
				function() {
					...
					if (confirm("是否去下载App?")) {
						window.location.href = "https://xingxiu.tv/applinks/index.html";
					};
				}, 2000);
		}
	} else {
