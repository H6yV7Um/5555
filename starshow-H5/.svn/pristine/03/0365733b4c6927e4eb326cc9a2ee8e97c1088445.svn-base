   ...
   //活动分享
    var shareActivity=function(){
      setBridgeCallHandler(bridge, {
        'action': '3',
        'share': {
          'share_url':"http://s.xingxiu.tv/activity/starZeroRange6/share.html",
          'title': "2018潮音发布夜，现场门票等你拿！",
          'content': "李宇春、莫文蔚、窦靖童、华晨宇等多位大咖与你相约国内首个顶尖潮音发布夜",
          'cover': "https://starshow-pic.b0.upaiyun.com/lakuo/music.jpg"
        }
      })
    }
})
  ...
  var initCommentPage=function(){
      ...
      if($("#btn_down").html()!=undefined){
	      $(".btn_msgSend").click(function(){
	        ...
	        if(jwt_token=="" || jwt_token==undefined){
            //授权
             window.location.href = host+"wechat/activityAuth?type=starZeroRange6";
         }else{
	          toComment(jwt_token);
	        }
	      })
