...
(function () {
	...
	if(sphereRadius>=114){sphereRadius=document.querySelector( "#layout" ).offsetHeight * 0.22}
	if(sphereRadius>=111){sphereRadius=document.querySelector( "#layout" ).offsetHeight * 0.22}
