...
var initDetailDom=function(ret,request){
	...
	var playHtml='<div class="player"></div><div class="shadow"></div><div class="pre_times" >'+ ret.begin_time_old+'&nbsp;&nbsp;start</div><div class="m-title">'+good.name+'</div>'+
	...
	$("#share_info").attr("title","[Information]"+good.name);
	// $("#share_info").attr("shareUrl","http://s.cangpai.lookmetv.com/en/auctionsOther/goodDetailShare.html?page="+ page +"&curInx="+ curInx +"&id="+ id);
	$("#share_info").attr("shareUrl","http://s.cangpai.lookmetv.com/en/auctionsOther/goodDetailShare.html?page="+ page +"&curInx="+ curInx +"&id="+ id );
	
}
var getDetailData=function(){
	var url="https://cangpai-collection.b0.upaiyun.com/Collection/auction/other/"+id+"_en/"+page+".json";
