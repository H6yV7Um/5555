...
/*=====lightbox方法=====*/
		...
		$('body').append('<div id="YLimgwrap"><div id="YLimgcon"><h4><a class="YLt_close" title="关闭"></a></h4><img id="YLimg"><a class="prev" href="javascript:;"></a><a class="next" href="javascript:;"></a></div></div>');
		...
		$('.YLlightbox a[rel="YLlightbox"]').click(function(e){
				...
				$('#YLimgcon').css({'top':50,'left':position_left});
				//赋值数组(图片地址)
				imgSrcArray=[];		//先清空
		...
		$('#YLimgwrap .YLt_size').click(function(){
				...
				$('#YLimgcon').css({'top':50,'left':position_left2});		//重定位
		});
		//=======显示翻页按钮=======//
		$("#YLimgcon").hoverDelay({
				hoverEvent: function(){
