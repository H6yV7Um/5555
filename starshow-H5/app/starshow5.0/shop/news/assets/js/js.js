...
var initPage=function(){
  ...
  $("#newContent").on("click",".prodCon",function(){
   ...
   //点击商品
   $("#newContent").on("click",".prodConSelf",function(e){
       var goodsId=$(this).attr("itemId");
       window.starResult.internalGoodsDetail(goodsId);
   })
...
$(function(){
    ...
    var url=host+"goods/"+id+"/news?jwt_token="+jwt_token;
    $.ajax({
        url: url,
        type: "get",
        dataType: 'json',
