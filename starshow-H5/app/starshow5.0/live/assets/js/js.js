...
var ajaxCommonFun=function(url, type, callbackFun, params) {
 ...
 var initDom=function(resultData){
      ...
      */
      ...
      if(data.status==-1){
         ...
         $(".video").hide();
          ...
          player.init({url:data.pull_hls,posterType:2,pic:data.cover,auto_play:0,autoSize:1},"player");
        ...
        /*if(data.replay_url!=null){*/
          ...
          $(".video-js source").attr("src",data.replay_url);*/ 
           var player = new CloudVodPlayer();
           player.init({uu:"853371",vu:data.vuid,p:"102",pu:"2576",posterType:2,pic:data.cover,auto_play:0,autoSize:1},"player");
        /*}else{
          $(".video").hide();
          $(".vedio_title").show();
    ...
    if(data.is_erect=="1"){
       ...
       var share_url="http://share.xingxiu.tv/starshow5.0/liveVertical/share.html?id="+data.id;
    }else{
      /*var share_url="http://testshare.xingxiu.tv/starshow5.0/live/share.html?id="+data.id;*/
       var share_url="http://share.xingxiu.tv/starshow5.0/live/share.html?id="+data.id;
    }
 ...
 var initDom3=function(resultData){
    ...
    if(resultData.top3!=undefined || resultData.top3!=null || resultData.top3!="" || resultData.top3.length>0){
      ...
      for(var i=0;i<resultData.page_data.length;i++){
         ...
         var share_url="http://share.xingxiu.tv/starshow5.0/liveVertical/share.html?id="+resultData.page_data[i].id
        }else{
/*var share_url="http://testshare.xingxiu.tv/starshow5.0/live/share.html?id="+resultData.page_data[i].id*/
         var share_url="http://share.xingxiu.tv/starshow5.0/live/share.html?id="+resultData.page_data[i].id
        }
  ...
  function initLeanCloud(){
    ...
    return tom.getConversation(conversation_id);
      ...
      conversation.on('message', function(message, conversation) {
        ...
        if(message._lcattrs.type!=7 && message._lcattrs.type!=8 && messages[i]._lcattrs.type!=9){
             var lihtml="<li> <div class='head_pic fl'><img src='"+
