$(function() {
	...
	$.get("json/shopping_sort.json", function(data) {
		...
		$.each(data, function(index, ele) {
			...
			for(var i in arr) {
				str1 += "<a href='html/shopping_list.html'>" + arr[i] + "</a>"; //每个列表长度不一
			}
			str = "<div class='sub_item'><div class='item_theme'><a href='html/shopping_list.html'>" + ele.name + "</a></div><div class='item_list'>" + str1 + "</div></div>";
			str1 = "";
