		...
		$.get("../json/detail.json",function(data){
			$.each(data,function(index,ele){
				for(var i in data[index].result){
					...
					//console.log(t)
					if(JSON.parse(localStorage.getItem("cart"))[t]){
						//console.log(1)
						...
						for(var j in arr){
								...
								if(JSON.parse(localStorage.getItem("cart"))[p_size]){
									str +=	"<tr class='shop_list' id='"+ele.pid+"_"+data[index].result[i].cid+"_"+arr[j]+"'>"
									+"<td  class='w50'><input type='checkbox' class='ck'/></td>"
									+"<td  class='w80'><img src='"+JSON.parse(localStorage.getItem("cart"))[t]+"'/></td>"
									+"<td  class='w120'>"+JSON.parse(localStorage.getItem("cart"))[p_num]+"</td>"
									+"<td  class='w290 p_info'><h2><a href='javascript:;'>"+JSON.parse(localStorage.getItem("cart"))[p_title]+"</a></h2><span>颜色:<em>"+JSON.parse(localStorage.getItem("cart"))[p_color]+"</em> 尺码:<i>"+arr[j]+"</i></span></td>"
									+"<td  class='w150'><span class='o_price'>¥<em>"+JSON.parse(localStorage.getItem("cart"))[p_oprice]+"</em></span><i class='n_price'>¥<em>"+JSON.parse(localStorage.getItem("cart"))[p_nprice]+"</em></i></td>"
									+"<td  class='w200'>"
									+"<button class='down'>-</button>"
									+"<input class='p_num' type='text' value='"+JSON.parse(localStorage.getItem("cart"))[p_size]+"' readonly='readonly' />"
									+"<button class='up'>+</button>"
									+"</td>"
									+"<td  class='p_jifen w80'>"+JSON.parse(localStorage.getItem("cart"))[p_size]*JSON.parse(localStorage.getItem("cart"))[p_nprice]+"</td>"
